...
public class CrystalTypes {
    ...
    public static final CrystalType REDSTONE_CRYSTAL_TYPE = createCrystalType(
            ...
            5, 2, GROWTH_STAGES_5, GrowableCrystalsMod.REDSTONE_CRYSTAL_PARTICLE,
            8, 14, 2, 10
    );
    ...
    public static final CrystalType COAL_CRYSTAL_TYPE = createCrystalType(
            ...
            5, 1.5f, GROWTH_STAGES_5, GrowableCrystalsMod.COAL_CRYSTAL_PARTICLE,
            8, 13, 2, 12
    );
    ...
    public static final CrystalType IRON_CRYSTAL_TYPE = createCrystalType(
            ...
            5, 3, GROWTH_STAGES_5, GrowableCrystalsMod.IRON_CRYSTAL_PARTICLE,
            8, 12, 2, 9
    );
    ...
    public static final CrystalType GOLD_CRYSTAL_TYPE = createCrystalType(
            ...
            5, 2, GROWTH_STAGES_5, GrowableCrystalsMod.GOLD_CRYSTAL_PARTICLE,
            8, 12, 2, 7
    );
    ...
    public static final CrystalType LAPIS_CRYSTAL_TYPE = createCrystalType(
            ...
            5, 1.5f, GROWTH_STAGES_5, GrowableCrystalsMod.LAPIS_CRYSTAL_PARTICLE,
            8, 14, 2, 8
    );
    ...
    public static final CrystalType DIAMOND_CRYSTAL_TYPE = createCrystalType(
            ...
            5, 5f, GROWTH_STAGES_5, GrowableCrystalsMod.DIAMOND_CRYSTAL_PARTICLE,
            8, 13, 2, 7
    );
    ...
    public static final CrystalType COPPER_CRYSTAL_TYPE = createCrystalType(
            ...
            5, 2f, GROWTH_STAGES_5, GrowableCrystalsMod.COPPER_CRYSTAL_PARTICLE,
            8, 14, 2, 9
    );
    ...
    public static final CrystalType EMERALD_CRYSTAL_TYPE = createCrystalType(
            ...
            5, 3.5f, GROWTH_STAGES_5, GrowableCrystalsMod.EMERALD_CRYSTAL_PARTICLE,
            8, 13, 2, 10
    );
